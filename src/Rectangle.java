...
public class Rectangle extends Application{
    ...
    public void start(Stage primaryStage){
        TextInputDialog textInputDialog = new TextInputDialog("Use SPACE to separate the height and width");
        ...
        alert.setContentText("The perimeter of your rectangle is " + perimeter + " and the area of your tringle is " + area);
        alert.showAndWait();
    }
}